...
module.exports = async (app, options) => {
  ...
  await deleteLines_(path.join(targetPath, iosProject), ['/* AntDesign.ttf in Resources */', '/* Entypo.ttf in Resources */', '/* EvilIcons.ttf in Resources */', '/* Feather.ttf in Resources */', '/* FontAwesome.ttf in Resources */', '/* FontAwesome5_Brands.ttf in Resources */', '/* FontAwesome5_Regular.ttf in Resources */', '/* FontAwesome5_Solid.ttf in Resources */', '/* Fontisto.ttf in Resources */', '/* Foundation.ttf in Resources */', '/* Ionicons.ttf in Resources */', '/* MaterialCommunityIcons.ttf in Resources */', '/* MaterialIcons.ttf in Resources */', '/* Octicons.ttf in Resources */', '/* SimpleLineIcons.ttf in Resources */', '/* Zocial.ttf in Resources */']);
